...
freeproc(struct proc *p)
{
  ...
  // If the process has a framebuffer mapping, unmap it from the page table without freeing the physical memory.
  if (p->fbva != 0)
  {
...
void kproc_create(void (*fn)(void), const char *name)
{
